...
interface NearbyEventCardNewProps {
  event: {
    id: string;
    name: string;
    category: string;
...
const nearbyEventCardNew: React.FC<NearbyEventCardNewProps> = ({
  event,
  onPress,
  onFavoritePress,
}) => {
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.detailsRow}>
          ...
          <Text style={styles.detailText}>
            {formatDateTime((event as any).startDate || event.date)}
          </Text>
        </View>
...
export default nearbyEventCardNew;